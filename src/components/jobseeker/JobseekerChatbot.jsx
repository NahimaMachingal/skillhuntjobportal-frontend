...
const JobseekerChatbot = ({ activeUser }) => {
  ...
  return (
    ...
    >
      <div className="mr-32 w-96 h-[600px] bg-white rounded-lg shadow-lg flex flex-col overflow-hidden">
...
{loading && ( // Show loader when loading
        ...
        {showQuestions && ( // Render common questions only if showQuestions is true
